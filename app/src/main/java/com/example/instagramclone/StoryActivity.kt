    ...
    private fun getStories(useId: String)
    {
        ...
        ref.addListenerForSingleValueEvent(object :ValueEventListener{
            override fun onDataChange(datasnapshot: DataSnapshot) {
                ...
                Picasso.get().load(imagesList!!.get(counter)).placeholder(R.drawable.loading).into(image_story)
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.exists())
                {
                    ...
                    Picasso.get().load(user!!.getImage()).placeholder(R.drawable.loading).into(story_profile_image)
